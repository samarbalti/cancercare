...
exports.registerDoctor = async (req, res, next) => {
  try {
    ...
    // Check if license number exists (only if provided)
    if (licenseNumber) {
    ...
    console.log('✅ Nouveau médecin inscrit:', {
    ...
    emailService.notifyNewDoctorRegistration({
      ...
      email: user.email,
      specialization
    }).catch(err => console.log('⚠️ Email non envoyé:', err.message));
